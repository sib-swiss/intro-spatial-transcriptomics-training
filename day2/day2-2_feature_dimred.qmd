...
We will start by loading the normalized `SpatialExperiment` object from the previous exercise, which contains filtered bins and genes with more than 1 count across all retained bins.

```{r}
# Load the normalized SpatialExperiment object.
spe <- loadHDF5SummarizedExperiment(dir="results/day2", prefix="02.1_spe")
```
...
```{r}
spe_HVG <- spe
saveHDF5SummarizedExperiment(spe_HVG, dir="results/day2", prefix="01.3_spe", replace=TRUE,
